...
var SvgViewerScreenRegular = function (props) { return (React.createElement("svg", __assign({ width: 40, height: 40, fill: "none" }, props),
    React.createElement("g", { filter: "url(#viewer-screen-regular_svg__filter0_d)", fill: "#fff" },
        React.createElement("path", { d: "M31 11l-2-2-4 4-3-3v8h8l-3-3 4-4zM13 25l-4 4 2 2 4-4 3 3v-8h-8l3 3z" })),
    React.createElement("defs", null,
        React.createElement("filter", { id: "viewer-screen-regular_svg__filter0_d", x: -2, y: -2, width: 44, height: 44, filterUnits: "userSpaceOnUse", colorInterpolationFilters: "sRGB" },
