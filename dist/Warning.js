...
var SvgWarning = function (props) { return (React.createElement("svg", __assign({ width: 40, height: 40, fill: "none" }, props),
    React.createElement("g", { filter: "url(#warning_svg__filter0_d)" },
        React.createElement("path", { d: "M19.5 14L13 25h13l-6.5-11zm.5 9.1h-1v-1h1v1zm-1-2v-3h1v3h-1z", fill: "#fff" })),
    React.createElement("defs", null,
        React.createElement("filter", { id: "warning_svg__filter0_d", x: 6, y: 6, width: 28, height: 28, filterUnits: "userSpaceOnUse", colorInterpolationFilters: "sRGB" },
