...
var SvgViewerView = function (props) { return (React.createElement("svg", __assign({ width: 40, height: 40, fill: "none" }, props),
    React.createElement("g", { filter: "url(#viewer-view_svg__filter0_d)" },
    ...
    React.createElement("defs", null,
        React.createElement("filter", { id: "viewer-view_svg__filter0_d", x: -2, y: -2, width: 44, height: 44, filterUnits: "userSpaceOnUse", colorInterpolationFilters: "sRGB" },
