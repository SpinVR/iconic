...
const SvgMouseDarkLeftDoubleClick = (props?: React.SVGProps<SVGSVGElement>) => (
  <svg width={49} height={49} fill="none" {...props}>
    ...
    />
    <mask
      id="mouse-dark-left-double-click_svg__a"
    ...
    <g mask="url(#mouse-dark-left-double-click_svg__a)">
      <path
        fillRule="evenodd"
        clipRule="evenodd"
...
export default SvgMouseDarkLeftDoubleClick;
