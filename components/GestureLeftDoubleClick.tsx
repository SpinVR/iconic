...
const SvgGestureLeftDoubleClick = (props?: React.SVGProps<SVGSVGElement>) => (
  <svg width={49} height={49} fill="none" {...props}>
    ...
    />
    <mask
      id="gesture-left-doubleClick_svg__a"
    ...
    <g mask="url(#gesture-left-doubleClick_svg__a)">
      <path
        fillRule="evenodd"
        clipRule="evenodd"
...
export default SvgGestureLeftDoubleClick;
