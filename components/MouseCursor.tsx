...
const SvgMouseCursor = (props?: React.SVGProps<SVGSVGElement>) => (
  <svg width={36} height={36} fill="none" {...props}>
    <mask id="mouse-cursor_svg__a" fill="#fff">
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M30.373 16.881L6.746 6.746 16.88 30.373l4.987-4.987 5.627 5.627 3.518-3.518-5.627-5.627 4.987-4.987z"
      />
    </mask>
    <path
      fillRule="evenodd"
